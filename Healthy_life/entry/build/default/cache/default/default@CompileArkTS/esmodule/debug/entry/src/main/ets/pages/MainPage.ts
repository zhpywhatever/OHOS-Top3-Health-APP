        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new HomeIndex(this, { homeStore: this.__homeStore, editedTaskInfo: this.__editedTaskInfo, editedTaskID: this.__editedTaskID }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/MainPage.ets", line: 116 });
            ...
            TabContent.create(() => {
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new AchievementIndex(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/MainPage.ets", line: 124 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new MineIndex(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/MainPage.ets", line: 129 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
