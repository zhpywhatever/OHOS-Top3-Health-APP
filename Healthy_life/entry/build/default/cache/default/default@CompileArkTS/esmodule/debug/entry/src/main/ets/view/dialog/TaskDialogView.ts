...
export class TaskDialogView extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.targetSettingDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new TargetSettingDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 33 });
        ...
        this.RemindTimeDialogController = new CustomDialogController({
            builder: () => {
                let jsDialog = new RemindTimeDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 40 });
                jsDialog.setController(this.
                // remind time dialog
        ...
        this.FrequencyDialogController = new CustomDialogController({
            builder: () => {
                let jsDialog = new FrequencyDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 47 });
                jsDialog.setController(this.
                // frequency dialog
