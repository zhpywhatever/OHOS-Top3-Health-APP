            ...
            if (this.homeStore.getTaskListOfDay().length > 0) {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                __Common__.height({ "id": 16777315, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
                            }, __Common__);
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new HealthText(this, { title: '', titleResource: { "id": 16777253, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }, fontSize: { "id": 16777294, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 153 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        title: '',
